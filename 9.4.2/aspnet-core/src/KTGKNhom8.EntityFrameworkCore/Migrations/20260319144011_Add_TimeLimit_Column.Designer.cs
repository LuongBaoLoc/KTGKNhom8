...
namespace KTGKNhom8.Migrations
{
    ...
    [Migration("20260319144011_Add_TimeLimit_Column")]
    partial class Add_TimeLimit_Column
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KTGKNHOM8.Toeic.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KTGKNHOM8.Toeic.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KTGKNHOM8.Toeic.ExamPart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KTGKNHOM8.Toeic.Passage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KTGKNHOM8.Toeic.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KTGKNhom8.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("KTGKNhom8.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("KTGKNhom8.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("KTGKNhom8.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("KTGKNHOM8.Toeic.Answer", b =>
                {
                    b.HasOne("KTGKNHOM8.Toeic.Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("KTGKNHOM8.Toeic.ExamAttempt", b =>
                {
                    b.HasOne("KTGKNHOM8.Toeic.Exam", "Exam")
                        .WithMany()
            ...
            modelBuilder.Entity("KTGKNHOM8.Toeic.ExamAttemptAnswer", b =>
                {
                    ...
                    b.HasOne("KTGKNHOM8.Toeic.Answer", "SelectedAnswer")
                        .WithMany()
            ...
            modelBuilder.Entity("KTGKNHOM8.Toeic.Passage", b =>
                {
                    b.HasOne("KTGKNHOM8.Toeic.ExamPart", "ExamPart")
                        .WithMany("Passages")
            ...
            modelBuilder.Entity("KTGKNHOM8.Toeic.Question", b =>
                {
                    ...
                    b.HasOne("KTGKNHOM8.Toeic.Passage", "Passage")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("KTGKNhom8.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("KTGKNhom8.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("KTGKNhom8.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
